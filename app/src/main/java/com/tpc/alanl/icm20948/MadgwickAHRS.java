...
public class MadgwickAHRS {
    private final static float SAMPLE_FREQ = 100.0f; // sample frequency in Hz
    private final static float BETA_DEF = 0.2f;      // 2 * proportional gain

    private volatile float beta = BETA_DEF;								// 2 * proportional gain (Kp)
    private volatile float q0 = 1.0f, q1 = 0.0f, q2 = 0.0f, q3 = 0.0f;	// quaternion of sensor frame relative to auxiliary frame

    public void MadgwickAHRS(){
    }
